...
import com.wenhaolei.tools.bean.M3U8;
import com.wenhaolei.tools.bean.M3U8Ts;
import com.wenhaolei.tools.bean.OnDownloadListener;
import com.wenhaolei.tools.bean.OnM3U8InfoListener;
...
public class M3U8DownloadTask {
    ...
    //临时下载目录
    private String tempDir = "sdcard/" + File.separator + "m3u8temp";
    //最终文件保存的路径
